              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="input-group mb-3">
                    <label class="input-group-text col-3 required" for="platMobil">No. Plat</label>
                    <input type="text" class="form-control" id="platMobil" name="plat" autocomplete="off" required>
                  </div>   
                  <div class="input-group mb-1">
                    <label class="input-group-text col-3 required" for="jenisMobil">Jenis Mobil</label>
                  ...
                  <div class="form-check input-group">
                    ...
                    <div class = "col-1">
                      <input class="form-check-input" type="checkbox" id="mobilAktif" name="check" value="1">
                      <label for="mobilAktif">Aktif</label>
                    </div>
                  </div>
      ...
      <div class="modal fade" id="masterModalEdit" tabindex="-1" role="dialog" aria-labelledby="masterModalEditlabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="input-group mb-3">
                    <label class="input-group-text col-3" for="editPlat">No Plat</label>
                    <input type="text" class="form-control" id="editPlat" name="edit_plat" readonly="readonly">
                  </div>   
                  <div class="input-group mb-1">
                    <label class="input-group-text col-3" for="editJenis">Jenis Mobil</label>
                  ...
                  <div class="form-check input-group">
                    ...
                    <div class = "col-1">
                      <input class="form-check-input" type="checkbox" id="aktifMobil" name="edit_aktif">
                      <label for="aktifMobil">Aktif</label>
                    </div>
                  </div>
                </div>
                <div class="modal-footer">
