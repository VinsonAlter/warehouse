              ...
              <div class="modal-content">
                ...
                <div class="modal-body">   
                  <div class="input-group mb-1">
                    <label class="input-group-text col-5 required" for="namaDatabase">Database Warehouse</label>
                  ...
                  <div class="form-check input-group">
                    ...
                    <div class = "col-1">
                      <input class="form-check-input" type="checkbox" id="databaseAktif" name="check" value="1">
                      <label for="databaseAktif">Aktif</label>
                    </div>
                  </div>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="input-group mb-3">
                    <label class="input-group-text col-5" for="editServer">Database Server</label>
                  ...
                  <div class="form-check input-group">
                    ...
                    <div class = "col-1">
                      <input class="form-check-input" type="checkbox" id="aktifServer" name="edit_aktif">
                      <label for="aktifServer">Aktif</label>
                    </div>
                  </div>
                </div>
                <div class="modal-footer">
