    ...
    try {
        ...
        if ($conn) {
            ...
            if($search) {
                ...
                $search_query = "WHERE PickerID LIKE '%$search%' OR Nama LIKE '%$search%'";
            ...
            $table = "SELECT [PickerID],[Nama],[Aktif] FROM [WMS-System].[dbo].[TB_Picker]";
            ...
            if($stmt->rowCount() > 0) {
                ...
                while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $aksi = '<a href="#" data-bs-toggle="modal" data-bs-target="#masterModalEdit" 
                               ...
                               onclick="getPicker(\''.$nama.'\')" ><i class="fa fa-edit"></i></a>';
