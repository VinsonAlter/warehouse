...
<htmL lang="en">
  <head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/sardana.png"/>
    <!-- Custom CSS -->
            ...
            <a class="navbar-brand" href="index.html">
              ...
              <span class="logo-text ms-2">
                ...
                <!-- <img
                  ...
                  class="light-logo"
                /> -->
                <h2 class="light-logo mt-2 page-logo">W M S</h2>
              </span>
              <!-- Logo icon -->
              <!-- <b class="logo-icon"> -->
              <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  ...
                  <li class="sidebar-item">
                    <a href="account.php" class="sidebar-link"
                      ...
                      ><span class="hide-menu">User Account</span></a>
                  </li>
                </ul>
              </li>
              <!-- <li class="sidebar-item">
                ...
                <div class="card-body">
                  ...
                  <div class="chat-box scrollable" style="height: 475px">
                    ...
                    <ul class="chat-list">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="assets/images/users.jpg" alt="user" />
                        </div>
