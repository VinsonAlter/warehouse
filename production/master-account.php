            ...
            <div class="card">
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="table_user" class="table table-striped table-bordered table-condensed display compact " style="width:95%">
                      <thead>
                        <tr>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="input-group mb-2">
                    <label class="input-group-text col-4 required" for="name">Name</label>
                    <input type="text" class="form-control" id="name" name="name" autocomplete="off" required> 
                  </div>
                  <div class="input-group mb-2">
                    <label class="input-group-text col-4 required" for="userName">Username</label>
                    <input type="text" class="form-control" id="userName" name="userName" autocomplete="off" required>  
                  </div>
                  <div class="input-group mb-2">
                    <label class="input-group-text col-4 required" for="password">Password</label>
                    <input type="text" class="form-control" id="password" name="password" autocomplete="off" required>
                  </div>
                  <div class="input-group mb-3">
                    <label class="input-group-text col-4 required" for="conf_pass">Confirm Password</label>
                    <input type="text" class="form-control" id="conf_pass" name="conf_pass" autocomplete="off" required>
                  </div>
                  ...
                  <div class = "input-group mb-2">
                    ...
                    <div class = "col-5">
                      <div class="form-check" style="margin-left:5px;">
                        <?php foreach ($database as $row): ?>
                          <label class="form-check-label" for="<?=$row['warehouse']?>"><?=$row['warehouse']?></label>
                          <input class="form-check-input" type="checkbox" id="<?=$row['warehouse']?>" name="server[]" class="server_warehouse" value="<?=$row['warehouse']?>" required>
                        <?php endforeach;?>
                      </div>
                    </div>
                    <!-- This is the write in code for the checkbox input labels -->
                    <!-- <div class = "col-4">
                      <div class="form-check" style="margin-left:5px;">
                        <input class="form-check-input" type="checkbox" id="TJM-MMKSI" name="TJM_MMKSI" value="SP-TJM-MMKSI">
                        <label class="form-check-label" for="TJM-MMKSI">SP-TJM-MMKSI</label>
                      </div>
                      <div class="form-check" style="margin-left:5px;">
                        <input class="form-check-input" type="checkbox" id="TJM-KTB" name="TJM-MMKSI" value="SP-TJM-KTB">
                        <label class="form-check-label" for="TJM-KTB">SP-TJM-KTB</label>
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="form-check" style="margin-left:9px;">
                        <input class="form-check-input" type="checkbox" id="RPT-MMKSI" name="RPT_MMKSI" value="SP-RPT-MMKSI">
                        <label class="form-check-label" for="RPT-MMKSI">SP-RPT-MMKSI</label>
                      </div>
                      <div class="form-check" style="margin-left:9px;">
                        <input class="form-check-input" type="checkbox" id="RPT-KTB" name="RPT_KTB" value="SP-RPT-KTB">
                        <label class="form-check-label" for="RPT-KTB">SP-RPT-KTB</label>
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="100011-MMKSI" name="100011_MMKSI" value="SP-100011-MMKSI">
                        <label class="form-check-label" for="100011-MMKSI">SP-100011-MMKSI</label>
                      </div>
                    </div> -->
                    <div class="form-check input-group">
                      ...
                      <div class = "col-1">
                        <input class="form-check-input" type="checkbox" id="userAktif" name="check" value="1">
                        <label for="userAktif">Aktif</label>
                      </div>
                    </div>
                  </div>
      ...
      function getUser(username) {
        ...
        $.ajax({
          ...
          success: result => {
            ...
            // ok, this one is dynamical function, just put the value inside 
            $testdata = $("#masterModalEdit input[name='server[]']").val(test);
            // if($.inArray(test, checkdata)){
            //  $testdata = $("#masterModalEdit input[type=checkbox]").val(test);
            //}
            // built-in function for prop checking checkbox, not optimal
            // if(checkdata.includes(test)){
