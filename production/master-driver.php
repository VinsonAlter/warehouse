              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="input-group mb-3">
                    <label class="input-group-text col-3 required" for="kodeDriver">Kode Driver</label>
                    <input type="text" class="form-control" id="kodeDriver" name="kode" autocomplete="off" required>
                  </div>   
                  <div class="input-group mb-1">
                    <label class="input-group-text col-3 required" for="namaDriver">Nama Driver</label>
                  ...
                  <div class="form-check input-group">
                    ...
                    <div class = "col-1">
                      <input class="form-check-input" type="checkbox" id="driverAktif" name="check" value="1">
                      <label for="driverAktif">Aktif</label>
                    </div>
                  </div>
      ...
      <div class="modal fade" id="masterModalEdit" tabindex="-1" role="dialog" aria-labelledby="masterModalEditlabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="input-group mb-3">
                    <label class="input-group-text col-3" for="editKode">Kode Driver</label>
                    <input type="text" class="form-control" id="editKode" name="edit_kode" readonly="readonly">
                  </div>   
                  <div class="input-group mb-1">
                    <label class="input-group-text col-3" for="editNama">Nama Driver</label>
                  ...
                  <div class="form-check input-group">
                    ...
                    <div class = "col-1">
                      <input class="form-check-input" type="checkbox" id="aktifDriver" name="edit_aktif">
                      <label for="aktifDriver">Aktif</label>
                    </div>
                  </div>
                </div>
                <div class="modal-footer">
